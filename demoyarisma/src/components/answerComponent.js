...
const AnswerComponent = (props) =>{
    ...
    return(
        ...
        <View  style={{height:40,width:250,borderRadius:38,borderWidth:1,borderColor:'white',marginLeft:'5%',marginTop:10,justifyContent:'center',alignItems:'flex-start',backgroundColor:'#6dbc7e'}}>
